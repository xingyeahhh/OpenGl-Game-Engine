...
int main()
{
	...
	*/
	...
	std::string groundPath = "/Resources/YoutubeOpenGL 17 - Transparency & Blending/models/ground/scene.gltf";
	std::string grassPath = "/Resources/YoutubeOpenGL 17 - Transparency & Blending/models/grass/scene.gltf";
	std::string winPath = "/Resources/YoutubeOpenGL 17 - Transparency & Blending/models/windows/scene.gltf";

	// Load in models
	Model ground("ground/scene.gltf");
	Model grass("grass/scene.gltf");
	Model windows("windows/scene.gltf");
